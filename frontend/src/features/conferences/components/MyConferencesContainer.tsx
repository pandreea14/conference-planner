  ...
  return (
    <Grid padding={3} sx={{ width: "100%", height: "100%" }}>
        ...
        <Grid container spacing={2} alignItems="center">
          <Grid sx={{ xs: 12, md: 6 }}>
            ...
            <Typography variant="body2" color="text.secondary">
              Total conferences: <strong>{conferences.length}</strong>
            </Typography>
          </Grid>
      ...
      {conferences.length === 0 && allConferences.length > 0 ? (
        ...
        <>
          <ConferenceListFilters state={state} onStateChange={setState} conferenceTypes={types} speakers={speakers} isOrganizer={true} />
...
export default MyConferencesContainer;
